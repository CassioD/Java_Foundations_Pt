public class Prisoner_7_6_Ex2_Soln {
    //Fields 
    private String name;
    private double height;
    private int sentence;
    private Cell_7_6_Ex2_Soln cell;
    private static int prisonerCount = 0;
    private int bookingNumber;
    
    
    //Constructor
    public Prisoner_7_6_Ex2_Soln(String name, double height, int sentence, Cell_7_6_Ex2_Soln cell){
 	this.name = name;
 	this.height = height;
    ...
    public Cell_7_6_Ex2_Soln getCell() {
        return cell;
    }
    //Setters
    ...
    public void setCell(Cell_7_6_Ex2_Soln cell) {
        this.cell = cell;
    }
}
